      ...
      <div class="row g-4 g-xl-5">
        <div class="col-12 col-xl-4">
          ...
          <h1 class="display-3 fw-medium mb-0">
            What I <span class="text-gradient">Do</span>
          </h1>
        </div>
          ...
          <div class="row g-4">
            ...
            <div class="col-12" @mouseenter="$store.commit('expandCursor')"
              ...
              <div class="service-box">
                ...
                <div class="service-text">
                  <p>
                    Proficient in Linux, GitHub, DevOps practices, server
                    management, networking, and automation tools.
                  </p>
                </div>
              </div>
            </div>
            <div class="col-12" @mouseenter="$store.commit('expandCursor')"
              ...
              <div class="service-box">
                ...
                <div class="service-text">
                  <p>
                    Expertise in ethical hacking, Arduino projects, and office
                    automation.
                  </p>
                </div>
              </div>
